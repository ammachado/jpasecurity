...
public class JpqlGrammarTest {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {"SELECT bean FROM TestBean bean WHERE bean.name NOT BETWEEN COALESCE(bean.name, 'Doe') AND bean.name"},
                {"SELECT bean FROM TestBean bean WHERE bean.name NOT BETWEEN COALESCE(bean.name, 'Doe') AND COALESCE(bean.name, 'Doe')"},
                ...
                {"SELECT bean FROM TestBean bean WHERE COALESCE(bean.name, 'Doe') = 'Horst'"},
                {"SELECT bean FROM TestBean bean WHERE COALESCE(bean.name, 'Doe') BETWEEN bean.name AND COALESCE(bean.name, 'Doe')"},
                {"SELECT bean FROM TestBean bean WHERE COALESCE(bean.name, 'Doe') IN ('Horst')"},
                ...
                {"SELECT bean FROM TestBean bean WHERE COALESCE(bean.name, 'Doe') NOT BETWEEN COALESCE(bean.name, 'Doe') AND COALESCE(bean.name, 'Hoerst')"},
                {"SELECT bean FROM TestBean bean WHERE EXISTS (SELECT bean FROM TestBean bean WHERE bean.id = :id)"},
                ...
                {"UPDATE TestBean bean SET bean.name = 'test', bean.id = 0 WHERE bean.id = 0"},
