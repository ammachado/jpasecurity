...
public class DefaultSecureEntityManager extends DelegatingEntityManager
    ...
    protected DefaultSecureEntityManager(SecureEntityManagerFactory parent,
        ...
        SubQueryEvaluator entityManagerEvaluator
    ...
    public Query createQuery(CriteriaUpdate criteria) {
        ...
        if (filterResult.getQuery() == null) {
            ...
            return createQuery(
                    super.createQuery(filterResult.getQuery()), filterResult, criteria.getRoot().getJavaType());
        }
    }
    ...
    public <T> TypedQuery<T> createQuery(CriteriaQuery<T> criteriaQuery) {
        ...
        if (filterResult.getQuery() == null) {
            ...
            return createQuery(super.createQuery(filterResult.getQuery()), filterResult,
                    criteriaQuery.getSelection().getJavaType());
        }
    }

    private <C extends CommonAbstractCriteria, Q extends Query> Q createQuery(Q query,
                                                                              FilterResult<C> filterResult,
                                                                              Class<?> clazz) {
        // TODO how to extract the constructorReturnType?
        Q secureQuery = (Q)new SecureQuery<>(query, clazz);
